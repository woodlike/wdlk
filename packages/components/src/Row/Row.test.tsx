...
describe('<Row />', () => {
  ...
  it('should not have accessibility violations', async done => {
    const { container, unmount } = render(<Row as="div">{id}</Row>);
  ...
  describe('flex basis', () => {
    it('should not have flex style property', () => {
      const { queryByText, unmount } = render(<Row as="div">{id}</Row>);
